...
Sahil Kumar\\
       ...
       \affaddr{IIT ROPAR}\\
       \email{2016csb1057@iitrpr.ac.in}
% 2nd. author
\alignauthor
Sameer \\
       \affaddr{Dept. of Computer Science}\\
...
\maketitle
\begin{abstract}
With the proliferation of \cite{grudin1994computer} mobile video cameras, it is becoming eas-
...
is not a reliable basis to select videos.\par
\begin{table*}
\centering
...
measure between current frame from the %i^{} video and j th frame
